package com.dauphine.demo.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dauphine.demo.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dauphine.demo.security.DomainUserDetailsService", "createSpringSecurityUser");
